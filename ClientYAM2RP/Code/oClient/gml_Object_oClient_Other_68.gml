    ...
    case 3:
        ...
        switch (msgid)
        {
            ...
            case 115:
                ...
                {
                    if (buffer_read(_buffer, buffer_u8) == 1 && global.saxmode && global.sax && !global.inventory[i] && instance_number(oCoreXSyncedItem) == 0 && string_count("rm_a", room_get_name(room)))
                    {
