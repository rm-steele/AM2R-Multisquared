...
if (argument3 == 0)
{
    if (global.currentsuit == 1)
    {
        ...
        {
            damage_taken = ceil(argument0 * 0.75) * oControl.mod_diffmult;
            damage_taken = damage_taken + (damage_taken * global.damageMult);
        }
    }
    ...
    if (global.currentsuit == 2)
    {
        ...
        {
            damage_taken = ceil(argument0 * 0.6) * oControl.mod_diffmult;
            damage_taken = damage_taken + (damage_taken * global.damageMult);
        }
    }
}
...
if (global.playerhealth > 0)
{
    with (oCharacter)
    {
        ...
        if (state != HURT && invincible == 0 && !global.ignoreKnockback)
        {
