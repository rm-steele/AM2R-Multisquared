...
op[num_fusionOverride] = instance_create(x, y + (sep * tempcount++), oOptionLR);
op[num_fusionOverride].label = "Fusion Mode Override"
op[num_fusionOverride].optionid = num_fusionOverride;
