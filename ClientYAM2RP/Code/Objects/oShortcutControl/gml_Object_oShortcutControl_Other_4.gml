if (global.shortcuts)
{
    ...
    switch (room)
    {
        case rm_a0h04d:
            ...
            if (!(oControl.mod_previous_room == 396 && global.inventory[8] == 0))
            {
        ...
        case rm_a0h28:
            ...
            if (!(oControl.mod_previous_room == 397 && global.inventory[7] == 0))
            {
        ...
        case rm_a0h24:
            ...
            if (!(oControl.mod_previous_room == 398 && global.inventory[8] == 0))
            {
        ...
        case rm_a1a06:
            ...
            if (!(oControl.mod_previous_room == 400 && global.inventory[8] == 0))
            {
        ...
        case rm_a3a20:
            ...
            if (!(oControl.mod_previous_room == 405 && global.inventory[7] == 0))
            {
            ...
            if (!(oControl.mod_previous_room == 395 && global.inventory[8] == 0))
            {
        ...
        case rm_a2c08:
            ...
            if (!(oControl.mod_previous_room == 401 && global.inventory[8] == 0))
            {
        ...
        case rm_a4h03:
            ...
            if (!(oControl.mod_previous_room == 406 && global.inventory[8] == 0))
            {
        ...
        case rm_a3b02:
            ...
            if (!(oControl.mod_previous_room == 404 && global.inventory[8] == 0))
            {
        ...
        case rm_a6a10:
            ...
            if (!(oControl.mod_previous_room == 407 && global.inventory[8] == 0))
            {
        ...
        case rm_a6b03:
            ...
            if (!(oControl.mod_previous_room == 408 && global.inventory[8] == 0))
            {
        ...
        case rm_a0h32:
            ...
            tile_layer_delete(-130);
            var blk = instance_create(96, 832, oBlockBomb);
            blk.regentime = -1;
            break;
