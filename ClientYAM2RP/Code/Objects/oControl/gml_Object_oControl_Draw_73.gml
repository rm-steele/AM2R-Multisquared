...
if ((!instance_exists(oClient) && (room == titleroom || room == rm_options)) && !global.TryConnect)
{
    ...
    draw_cool_text((view_xview[0] + 18) - (oControl.widescreen_space / 2), view_yview[0] + 227, "Multitroid: Offline", 0, 16777215, 8421504, 1);
}
if (global.TryConnect)
{
    draw_sprite_ext(sPingStrength, 3, view_xview[0] - (oControl.widescreen_space / 2), view_yview[0] + 224, 1, 1, 0, c_white, 1);
    draw_set_font(global.fontMenuSmall);
    draw_cool_text((view_xview[0] + 18) - (oControl.widescreen_space / 2), view_yview[0] + 227, "Connecting, Please Wait...", 0, 16777215, 8421504, 1);
}
if (instance_exists(oClient))
{
    ...
    draw_set_font(global.fontMenuSmall);
    draw_cool_text((view_xview[0] + 18) - (oControl.widescreen_space / 2), view_yview[0] + 227, string(global.ping), 0, 16777215, 8421504, 1);
}
